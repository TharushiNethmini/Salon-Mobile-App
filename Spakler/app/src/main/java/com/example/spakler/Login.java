...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //to navigate to the sign up screen once click in the signup btn
        ...
        LoginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (emailLogin.isEmpty()) {
                    EmailLogin.setError("Username can not be empty.");
                }
                if (passLogin.isEmpty()) {
                   ...
                   reference.addListenerForSingleValueEvent(new ValueEventListener() {
                       ...
                       public void onDataChange(@NonNull DataSnapshot snapshot) {
                           //to check the record by the user name
                           if(snapshot.hasChild(emailLogin)){
                               ...
                               //to check the admin or user
                               //if it is a admin it will go to the admin dashboard
